...
__ALIGN_BEGIN static uint8_t CUSTOM_HID_ReportDesc_FS[USBD_CUSTOM_HID_REPORT_DESC_SIZE] __ALIGN_END =
{
  ...
  0x05, 0x0c,                    //   USAGE_PAGE (Keyboard)
  0x19, 0x00,                    //   USAGE_MINIMUM (Keyboard LeftControl)
  0x2a, 0xff, 0x0f,                    //   USAGE_MAXIMUM (Keyboard Right GUI)
  0x15, 0x00,                    //   LOGICAL_MINIMUM (0)
  0x26, 0xff, 0x0f,                    //   LOGICAL_MAXIMUM (1)
  0x75, 0x08,                    //   REPORT_SIZE (1)
  0x95, 0x02,                    //   REPORT_COUNT (8)
...
static int8_t CUSTOM_HID_OutEvent_FS(uint8_t event_idx, uint8_t state)
{
  ...
  USB_Recive_Buffer[1]=hhid->Report_buf[1];  //把接收到的数据送到自定义的缓存区保存（Report_buf[i]为USB的接收缓存区）
  return (USBD_OK);
  /* USER CODE END 6 */
}
